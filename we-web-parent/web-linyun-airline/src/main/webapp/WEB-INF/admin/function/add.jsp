...
<div class="panel_box">
	<div class="panel_content nopadding">
		<form method="post" action="${base}/admin/function/add.html" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
			<div class="form_item">
			...
			<div class="form_item">
				<label class="form_label">访问地止：</label>
			  	<div class="form_ctrl">
			    	<input name="url" type="text" class="required"  maxlength="10"/>
			  	</div>
			</div>
			...
			<div class="form_item">
				<label class="form_label">功能等级</label>
			  	<div class="form_ctrl">
			    	<input name="level" type="text" class="required"  maxlength="10"/>
			  	</div>
			</div>
			<div class="form_item">
			...
			<div class="form_item">
				<label class="form_label">序号：</label>
			  	<div class="form_ctrl">
			    	<input name="sort" type="text" class="required"  maxlength="10"/>
			  	</div>
			</div>
