          	...
          	<div class="modal-body modal-bod" style="height:632px;overflow-y:auto; ">
          	  <div class="row"><!--文件名称/PNR/退税状态-->
                  ...
                  <div class="col-sm-2 padding">
                  		<input id=" " name=" " type="text" class="form-control input-sm inputWidth" placeholder=" "/>
                  </div>
                </div>  
              	<div class="form-group inline">
                ...
                <div class="form-group inline">
                  ...
                  <div class="col-sm-2 padding">
                  		<input id=" " name=" " type="text" class="form-control input-sm inputWidth" placeholder="请输入票价" />
                  </div>
                </div>  
                <div class="form-group inline">
