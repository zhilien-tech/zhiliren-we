			...
			<form id="editUserForm" method="post">
					...
					<div class="form-group form-group1">
						...
						<div class="col-sm-3 padding">
							<input id="telephone" name="telephone" type="text"
								class="form-control input-sm inputWidth"
								value="${obj.userInfo.telephone}" /> <span class="prompt">*</span>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="form-group">
						...
						<div class="col-sm-3 padding">
							<input id="email" name="email" type="eamil"
								class="form-control input-sm inputWidth"
								value="${obj.userInfo.email}" />
						</div>
					</div>
					<div class="form-group form-group1">
						<label class="col-sm-2 text-right padding">所属部门：</label>
						<div class="col-sm-3 padding">
							<select id="deptId" name="deptId" onchange="selectDeptName();"
								class="form-control input-sm inputWidth">
				...
				<div class="row">
					<div class="form-group">
						...
						<div class="col-sm-8 padding">
							<select id="areaSelect" name="dictAreaName"
