...
$(document).ready(function(){
    ...
    $(".sidebar-menu > li >ul > li").click(function(){
		 $(".sidebar-menu > li").removeClass('active');
        $(this).parent().parent().addClass("active");//同时 添加记录样式
    });
    
    if(_index!=null && undefined != _index && _index != ""){
    	//$(".sidebar-menu  li").eq(_index).parent().parent().siblings().removeClass('active');
    	$(".sidebar-menu  li").eq(_index).parent().parent().siblings().css("border","solid 1px red");
    	$(".sidebar-menu  li").eq(_index).parent().parent().addClass("active");//当前下标的元素添加样式
    }else{
    	$(".sidebar-menu  li").eq(0).parent().parent().siblings().removeClass('active');
    	$(".sidebar-menu  li").eq(0).parent().parent().addClass("active");//当前下标的元素添加样式
    }  */
});
</script>
</html>
