		...
		<form method="post" action="${base}/admin/activity/update.html" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
			...
			<div class="form_item">
				<label class="form_label">标题：</label>
			  	<div class="form_ctrl">
			    	<input name="title" type="text" class="required"  maxlength="10" value="${obj.Activity.title}" readonly="readonly"/>
			  	</div>
			</div>
			...
			<div class="form_item">
				...
				<div class="form_ctrl" >
			       ...
			       <img alt="" src="${obj.Activity.cover}">
				</div>
			</div>
			<br>	<br>
			<div class="form_item">
				...
				<div class="form_ctrl " >
					<input  name="beginTime" type="text"  datefmt="yyyy-MM-dd HH:mm:00" value="${obj.Activity.beginTime}" readonly="readonly"/>
				</div>
			</div>
			...
			<div class="form_item">
				...
				<div class="form_ctrl change" >
					<input   name="endTime" type="text"  datefmt="yyyy-MM-dd HH:mm:00" value="${obj.Activity.endTime}" readonly="readonly"/>
				</div>
			</div> 
			<div class="form_item">
