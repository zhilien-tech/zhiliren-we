...
<%--加载默认主题样式 --%>
<link href="${base}console/rc/common/themes/css/base.css" rel="stylesheet" type="text/css" />
<link href="${base}console/rc/common/themes/css/common.css" rel="stylesheet" type="text/css" />
<link href="${base}console/rc/common/themes/default/style.css" rel="stylesheet" type="text/css" id="themeStyle" />

<%-- 加载日志、文件加载器、seajs、配置--%>
<script type="text/javascript" src="${base}console/common/js/stacktrace.js"></script>
<script type="text/javascript" src="${base}console/common/js/wefileloader.js"></script>
<script type="text/javascript" src="${base}console/common/js/seajs/seajs/2.2.0/sea.js"></script>
<script type="text/javascript" src="${base}console/common/js/config.js"></script>
<script type="text/javascript" src="${base}console/rc/common/js/config.js"></script>
</head>
<body>
<!-- header start -->
<div id="header">
