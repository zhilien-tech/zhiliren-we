define(function (require, exports, module) {
	...
	(function ($, window, undefined) {
        ...
        artDialog.fn = artDialog.prototype = {
            ...
            constructor: function (config) {
                ...
                dom.wrap.find('.d-content').attr('id', 'd-content-'+config.id);
            ...
            size: function (width, height) {
            	...
            	var style = this.dom.content[0].style;
    ...
    */
            ...
            close: function () {
                ...
                if (beforeunload && beforeunload.call(this,param) === false) {
                    return this;
                };
                ...
                if (_singleton) {
                    ...
                    $wrap.trigger(we.eventType.pageClear).css({
                        left: 0,
                        top: 0,
            ...
            focus: function () {
                ...
                if (this.config.focus) {
                    //setTimeout(function () {
                    try {
                        var elem = this._focus && this._focus[0] || this.dom.title[0] || this.dom.close[0];
                        elem && elem.focus();
                        // IE对不可见元素设置焦点会报错
                    } catch (e) {};
                    //}, 0);
    ...
    document.addEventListener('focus', focusin, true);
        ...
        artDialog._templates =
            '<div class="d-outer" role="dialog" tabindex="-1" aria-labelledby="d-title-{id}" aria-describedby="d-content-{id}">' + '<table class="d-border">' + '<tbody>' + '<tr>' + '<td class="d-nw"></td>' + '<td class="d-n"></td>' + '<td class="d-ne"></td>' + '</tr>' + '<tr>' + '<td class="d-w"></td>' + '<td class="d-c">' + '<div class="d-inner">' + '<table class="d-dialog">' + '<tbody>' + '<tr>' + '<td class="d-header">' + '<div class="d-titleBar">' + '<div id="d-title-{id}" class="d-title"></div>' + '<a class="d-close" href="javascript:;">×</a>' + '</div>' + '</td>' + '</tr>' + '<tr>' + '<td class="d-main">' + '<div id="d-content-{id}" class="d-content"></div>' + '</td>' + '</tr>' + '<tr>' + '<td class="d-footer">' + '<div class="d-buttons"></div>' + '</td>' + '</tr>' + '</tbody>' + '</table>' + '</div>' + '</td>' + '<td class="d-e"></td>' + '</tr>' + '<tr>' + '<td class="d-sw"></td>' + '<td class="d-s"></td>' + '<td class="d-se"></td>' + '</tr>' + '</tbody>' + '</table>' + '</div>';
