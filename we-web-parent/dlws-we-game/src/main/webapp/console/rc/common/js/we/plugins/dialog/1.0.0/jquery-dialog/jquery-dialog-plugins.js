define(function (require, exports, module) {
    ...
    (function ($) {
         ...
         */
        $.alert = $.dialog.alert = function (content, type, time, callback) {
        	var time_def = 3000,
        		title;
        	...
        	if(typeof content != 'string'){
        		seajs.log("调用 $dialog.alert 时类型出错！请检查。");
        		return;
        	}
        	...
        	if(type=='success'){
    			...
    			title = false;
    			esc = false;
    			content = '<span class="alert-loading">' + content + '<span class="loading-blue"></span></span>';
    			setTimeout(function(){
