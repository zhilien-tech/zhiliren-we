...
<div class="panel_box">
	<div class="panel_content nopadding">
		<form method="post" action="${base}/admin/genuser/add.html" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
			...
			<div class="form_item">
				<label class="form_label">年龄：</label>
			  	<div class="form_ctrl">
			    	<input name="age" type="text" class="required"  maxlength="10"/>
			  	</div>
			</div>
			<div class="form_item">
