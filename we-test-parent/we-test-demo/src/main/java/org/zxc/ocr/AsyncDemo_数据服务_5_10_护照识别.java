...
public class AsyncDemo_数据服务_5_10_护照识别 {

	private AsyncApiClient_数据服务_5_10_护照识别 asyncClient = null;

	public AsyncDemo_数据服务_5_10_护照识别() {
		this.asyncClient = AsyncApiClient_数据服务_5_10_护照识别.newBuilder().appKey("your app key here")
				.appSecret("your app secret here").build();
	}

	public void 印刷文字识别_护照识别Demo(byte[] body) {
		asyncClient.印刷文字识别_护照识别(body, new ApiCallBack() {
			@Override
