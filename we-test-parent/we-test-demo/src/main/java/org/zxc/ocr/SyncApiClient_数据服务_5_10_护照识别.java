...
@ThreadSafe
public final class SyncApiClient_数据服务_5_10_护照识别 extends BaseApiClient {
	public final static String GROUP_HOST = "ocrhz.market.alicloudapi.com";

	private SyncApiClient_数据服务_5_10_护照识别(BuilderParams builderParams) {
		super(builderParams);
	}

	@NotThreadSafe
	public static class Builder extends
			BaseApiClientBuilder<SyncApiClient_数据服务_5_10_护照识别.Builder, SyncApiClient_数据服务_5_10_护照识别> {

		@Override
		protected SyncApiClient_数据服务_5_10_护照识别 build(BuilderParams params) {
			return new SyncApiClient_数据服务_5_10_护照识别(params);
		}
	}

	public static Builder newBuilder() {
		return new SyncApiClient_数据服务_5_10_护照识别.Builder();
	}

	public static SyncApiClient_数据服务_5_10_护照识别 getInstance() {
		return getApiClassInstance(SyncApiClient_数据服务_5_10_护照识别.class);
	}

	public ApiResponse 印刷文字识别_护照识别(byte[] _body) {
