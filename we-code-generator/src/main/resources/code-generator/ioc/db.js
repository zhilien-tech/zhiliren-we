{
	...
	dataSource : {
	    ...
	    fields : {
			url : {java:"$propConfig.get('jdbc_url')"},
			username : {java:"$propConfig.get('jdbc_username')"},
			password : {java:"$propConfig.get('jdbc_password')"},
    ...
    loader:{
        // 根据表结构生成代码
        type:'com.we.generator.load.MysqlEntityLoader'
    }
}